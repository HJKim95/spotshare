...
class DustApiHelper {
    ...
    static let shared = DustApiHelper()
    
    func todayDustInfo(cityName:String, subLocalName: String , dustData: @escaping (_ data:todayDust) -> Void) {
    ...
    func requestDust(cityName:String, completion: @escaping (_ dustValue:JSON) -> Void) {
...
struct todayDust {
    ...
    var dustPM10Comment:String
    var dustPM25Comment:String
